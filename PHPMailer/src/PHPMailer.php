...
class PHPMailer
{
    ...
    {
        //It's not possible to use shell commands safely (which includings the mail() function) without escapeshellarg,
     ...
     * includings complete headers and body.
     ...
     * Picks shortest of Q, B, or none. Result includings folding if needed.
