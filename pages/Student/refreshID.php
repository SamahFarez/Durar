        ...
        <form action="../../includings/editProfile.php" method="post">
            <table>
                <tr>
                    ...
                    <td>
                        <input type="text" id="fname" name="fname"
                            placeholder="<?php echo $studentRow['student_fname'] ?>">
                    </td>
                </tr>
                <tr>
                    <th> اللقب: </th>
                    <td>
                        <input type="text" id="lname" name="lname"
                            placeholder="<?php echo $studentRow['student_lname'] ?>">
                    </td>
                </tr>
                <tr>
                    <th> بلد الإقامة: </th>
                ...
                <tr>
                    <th> رقم الهاتف: </th>
                    <td dir="ltr">
                        <input type="tel" name="tel" id="tel" placeholder="<?php echo $studentRow['student_phone'] ?>">
                    </td>
                </tr>
            </table>
